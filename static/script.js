...
var giftforContainer = document.querySelector('.giftfor');
var allCards = document.querySelectorAll('.giftfor--card');
var nope = document.getElementById('nope');
var love = document.getElementById('love');

function initCards(card, index) {
  var newCards = document.querySelectorAll('.giftfor--card:not(.removed)');
...
function createButtonListener(love) {
  return function (event) {
    var cards = document.querySelectorAll('.giftfor--card:not(.removed)');
